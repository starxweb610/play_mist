...
- **Profile layout**: sections render only when non-empty, in the order *Play Mist Games → Projects → External Portfolio*; with none, visitors see "This developer has not published any game/project/portfolio yet…".
